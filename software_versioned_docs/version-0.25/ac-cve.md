...
If you run on Astronomer Cloud or Software, refer to [Upgrade Apache Airflow on Astronomer](manage-airflow-versions.md) for detailed guidelines on how to upgrade between Airflow versions on the platform.
