...
![CI/CD Workflow Diagram](/img/docs/software/ci-cd-flow.png)
...
![New Service Account](/img/docs/software/ci-cd-new-service-account.png)
...
![Name Service Account](/img/docs/software/ci-cd-name-service-account.png)
...
![Service Account](/img/docs/software/ci-cd-api-key.png)
