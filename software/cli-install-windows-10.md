...
## Astronomer Software CLI on Windows 10 (PowerShell)

You can install a Windows adapted version of the Astronomer Software CLI directly by following the instructions below.
