...
![application](/img/docs/software/azure-application.png)
...
![authentication.png](/img/docs/software/azure-authentication.png)
...
![Custom login button on the Astronomer login screen](/img/docs/software/custom-oauth.png)
