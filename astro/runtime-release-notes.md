...
- Bumped `openlineage-airflow` to `0.5.2`
...
- The Airflow UI now shows a project's Runtime version in the footer of all pages:

    ![Runtime Version banner](runtime-version.png)
