...
| [Virtual Machines (nodes)](https://docs.microsoft.com/en-us/azure/virtual-network/network-overview)                       | Hosts all system and Airflow components on Astro, including workers and schedulers. Auto-scale based on the demand for nodes in your cluster. | Standard_D4d_v5                                                                               |
