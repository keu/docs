...
If your current worker type doesn't have the right combination of resources for your workflows, see [Manage Worker Types](manage-hybrid-clusters.md#manage-worker-types) to learn about adding additional worker types to your cluster.
