...
- Astronomer [activated your installation](https://docs.astronomer.io/astro/category/install-astro-hybrid).
- You [connected your cloud resources](https://docs.astronomer.io/astro/category/connect-to-external-resources) to Astro.
