...
- You can't use the operator launch a Pod in any worker queue other than the one running the operator's parent task. To run a launch a Pod in a different instance type you must launch it in a Kubernetes cluster outside of the Astro data plane.
