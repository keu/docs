...
- Apply custom tags (AWS only). Custom tags help your organization quickly identify and categorize your clusters by purpose, owner, or other business need. For example, you can request a tag that helps you quickly identify a production or a test cluster.
