...
If you prefer to work within a CLI, Deployments can also be created using the Astro CLI's [`deployment create`](cli-reference/astrocloud-deployment-create.md) command.
