...
def log_data_analysis(df: pd.DataFrame):
    ...
    # Compatible with Postgres. If you are using a database other than Postgres,
    # you might need to adjust the pd.DataFrame column names in this code to be lowercase.
