...
6. After the DAG run has finished successfully, verify in your Fivetran UI that the sync job shows an additional `Manual Update Triggered` entry in its `User Actions`.
